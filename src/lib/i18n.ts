...
export const translations = {
  en: {
    ...
    "settings.test.availableModels": "Available on endpoint \u2014 click to use:",
    "settings.test.copy": "Copy error",
    "settings.test.copied": "Copied!",
    "settings.test.tested": "tested \u2713",
  ...
  fr: {
    ...
    "settings.test.availableModels": "Disponibles sur l'endpoint — cliquez pour utiliser :",
    "settings.test.copy": "Copier l'erreur",
    "settings.test.copied": "Copié !",
    "settings.test.tested": "testé ✓",
