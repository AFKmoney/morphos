...
const SALES_DATA = [
  { name: "Lun", ventes: 4200, visites: 2400 },
  { name: "Mar", ventes: 3800, visites: 1398 },
  { name: "Mer", ventes: 5300, visites: 3800 },
  { name: "Jeu", ventes: 4780, visites: 3908 },
  { name: "Ven", ventes: 6890, visites: 4800 },
  { name: "Sam", ventes: 7390, visites: 3800 },
  { name: "Dim", ventes: 5490, visites: 4300 },
];
  ...
  return (
    <div className="flex flex-col h-full p-3 gap-3 thin-scroll overflow-y-auto">
      <div className="grid grid-cols-4 gap-2">
        <Kpi label="Ventes" value="€42.8k" delta="+12.4%" up icon={DollarSign} color="#34d399" />
        <Kpi label="Visiteurs" value="24,591" delta="+8.2%" up icon={Users} color="#22d3ee" />
        <Kpi label="Conversion" value="3.42%" delta="-0.4%" up={false} icon={Eye} color="#fbbf24" />
        <Kpi label="Panier moy." value="€68" delta="+2.1%" up icon={ShoppingCart} color="#f472b6" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 flex-1 min-h-0">
        <div className="bg-black/30 border border-white/8 rounded-lg p-2 flex flex-col">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={SALES_DATA} margin={{ top: 6, right: 6, bottom: 0, left: -20 }}>
              <defs>
              ...
              />
              <Area type="monotone" dataKey="ventes" stroke="#22d3ee" strokeWidth={2} fill="url(#g1)" />
              <Area type="monotone" dataKey="visites" stroke="#f472b6" strokeWidth={2} fill="url(#g2)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
